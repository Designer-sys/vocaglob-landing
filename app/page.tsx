  ...
  return (
    <main className="font-sans">
      ...
      <section className="text-center py-32 bg-gray-50">
        <h1 className="text-5xl font-bold text-blue-900">Build Confident Spoken Vocabulary</h1>
      ...
      <section className="py-20 max-w-3xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-blue-900 mb-6">What is Vocaglob?</h2>
      ...
      <section className="py-20 text-center bg-gray-100">
        <h2 className="text-3xl font-bold text-blue-900 mb-6">Sample Lesson Preview</h2>
      ...
      <section className="py-20 text-center">
        <h2 className="text-3xl font-bold text-blue-900">Get Ready to Start Your 90-Day Vocabulary Journey</h2>
